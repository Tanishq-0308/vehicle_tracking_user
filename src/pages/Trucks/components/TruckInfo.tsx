import { IonBackButton, IonButton, IonCard, IonCardContent, IonCol, IonContent, IonGrid, IonHeader, IonIcon, IonInput, IonItem, IonList, IonMenuButton, IonPage, IonRow, IonSegment, IonSegmentButton, IonSegmentContent, IonSegmentView, IonTitle, IonToolbar } from '@ionic/react';
...
const TruckInfo: React.FC = () => {
    ...
    const { truckDetail } = useContext<AdminContextType | undefined>(AdminContext);
        ...
        <IonPage>
            <IonHeader className='bg-[#2e363b]' >
                <IonToolbar color={'transparent'}>
                    ...
                    <IonTitle color={'medium'}>Truck Info</IonTitle>
                </IonToolbar>
                <div className=' bg-[#2e363b] text-white'>
                    <div className='flex pb-4 ml-6'>
                        ...
                        <div>
                            <h2 className='m-0 mt-5 text-lg font-bold leading-4 pb-2 text-[#27bd2e]' >{truckDetail.gps_data.status}</h2>
                            <p className='flex items-center m-0 '> On a way to  <span className='font-semibold mx-1'>Hamilton</span>
